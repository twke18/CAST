"""Define MOCO builder for contrastive learning.
...
class MoCo_SupPix(MoCo_ViT):
    ...
    def forward(self, x1, x2, y1, y2, m):
        ...
        # compute features
        q1 = self.base_encoder(x1, y1)
        q1 = self.predictor(q1)
        q2 = self.base_encoder(x2, y2)
        ...
        contrastive_loss = (
            self.contrastive_loss(q1, k2, self.T) +
            self.contrastive_loss(q2, k1, self.T)
        )
