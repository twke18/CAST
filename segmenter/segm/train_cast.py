...
from segm.model.factory import create_superpix_segmenter
...
from segm.engine_cast import train_one_epoch, evaluate
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if eval_epoch:
            eval_logger = evaluate(
                ...
                window_stride,
                amp_autocast,
                normalization=val_loader.dataset.normalization,
            )
